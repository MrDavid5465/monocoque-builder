...
export const encoderControlSchema = (props: SchemaProps): ComponentSchema => ({
  ...
  fields: {
    ...
    // Knob
    encoderKnobFile:  { label: 'Knob sprite', type: 'select', options: props.spriteOptions, section: 'Knob' },
    ...
    // Button appearance
    encoderBtnOnFile:       { label: 'Button ON sprite', type: 'select', options: props.spriteOptions, section: 'Button' },
    encoderBtnOffFile:      { label: 'Button OFF sprite', type: 'select', options: props.spriteOptions, section: 'Button' },
